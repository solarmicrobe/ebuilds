...
DESCRIPTION="Feed the Beast Infinity 1.7 server for Minecraft"
HOMEPAGE="http://feed-the-beast.com/"
SRC_URI="http://www.creeperrepo.net/FTB2/modpacks%5EFTBInfinity%5E`echo ${PV} | tr '.' _`%5EFTBInfinityServer.zip"
LICENSE="as-is"
SLOT="1.7/0"
KEYWORDS="~amd64 ~x86"
IUSE="ipv6"
